# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 11:13:02 2019
...
def proceso(env, cpu, ram, ramNecesitado, x):
    ...
    print(f'Numero de instrucciones: {x}')
    print(f'Memoria ram a utilizarse: {ramNecesitado}')
    print(f'Memoria ram disponible: {ram.level}')
    instanteDeInicio = env.now 
    uso.append(ram.level)
